  ...
  <body class="{{ $color }}">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-sm-6">
            ...
            <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
              ...
              >
              <a href="https://codecanyon.net/item/storego-saas-online-store-builder/31116337?s_rank=11" class="btn btn-outline-light" target="_blank"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
      <div class="container">
        ...
        src="{{asset('landing/images/storego-saas-pic-1.png')}}"
        alt=""
      ...
      <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
          <div class="col-sm-4">
            ...
            <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
              <a href="https://codecanyon.net/item/storego-saas-online-store-builder/31116337?s_rank=11" class="btn btn-primary" target="_blank"
                ><i class="fas fa-shopping-cart me-2"></i>Buy now</a
              >
            </div>
          </div>
          <div class="col-sm-6">
            <img
              src="{{asset('landing/images/storego-saas-pic-2.png')}}"
              alt="Datta Able Admin Template"
              class="img-fluid header-img wow animate__fadeInRight"
              data-wow-delay="0.2s"
            />
    ...
    <section class="side-feature">
      <div class="container">
        ...
        <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
            ...
            <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
              <a href="https://codecanyon.net/item/storego-saas-online-store-builder/31116337?gclid=EAIaIQobChMI-4mW3qTk-AIVkZlmAh0ayA-pEAAYASAAEgLEuPD_BwE" class="btn btn-primary" target="_blank"
                ><i class="fas fa-shopping-cart me-2"></i>Buy now</a
              >
            </div>
          </div>
          <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
            <div class="row feature-img-row m-auto">
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-3.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.2s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-4.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.4s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-5.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.6s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-7.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.8s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-9.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.3s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-8.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.5s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-6.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.7s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="{{asset('landing/images/storego-saas-pic-10.png')}}"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.9s"
                  alt="Admin"
                />
