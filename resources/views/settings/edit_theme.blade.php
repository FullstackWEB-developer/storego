                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            @if (Auth::user()->type == 'Owner')
                                ...
                                @if ($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme4' || $theme == 'theme5' || $theme == 'theme6')
                                    <a href="#Header_Setting" id="Header_Setting_tab"
                                        class="list-group-item list-group-item-action border-0">{{ __('Home Header') }}
                                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                    </a>
                                @endif
                                @if ($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme4' || $theme == 'theme3' || $theme == 'theme5' || $theme == 'theme6')
                                ...
                                @endif
                                @if ($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme4' || $theme == 'theme3' || $theme == 'theme6')
                                    <a href="#Categories" id="Categories_tab"
                                        class="list-group-item list-group-item-action border-0">{{ __('Home Categories') }}
                                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                    </a>
                                @endif
                                @if ($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme3' || $theme == 'theme4' || $theme == 'theme5' || $theme == 'theme6')
                            ...
                            @endif
                                @if ($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme5' || $theme == 'theme6')
                                                    ...
                                                    @for ($i = 0; $i < $loop1; $i++)
                                                        ...
                                                        @foreach ($section['inner-list'] as $inner_list_key => $field)
                                                            ...
                                                            @if ($field['field_type'] == 'text')
                                                                @if($field['field_name'] == 'Footer Quick Link Header Name 1' || $field['field_name'] == 'Footer Quick Link Header Name 2' || $field['field_name'] == 'Footer Quick Link Header Name 3' ||$field['field_name'] == 'Footer Quick Link Header Name 4')
                                                                    <div class="col-sm-12" >
                                                                @else
                                                                    <div class="col-sm-6">
                                                                @endif
                                                            ...
                                                            @if ($field['field_type'] == 'photo upload')
                                                                <div class="col-sm-6">
                                                                    @if ($section['array_type'] == 'multi-inner-list')
                                                                        ...
                                                                        @else
                                                                            <img src="{{ asset(Storage::url('uploads/' . $field['field_default_text'])) }}"
                                                                                style="width: auto; max-height: 80px;">
                                                                        @endif
                                                                    @else
                                                                        <div class="form-group">
                                                            ...
                                                            @if ($field['field_type'] == 'checkbox')
                                                                ...
                                                                @if($field['field_name'] == 'Enable Testimonial' || $field['field_name'] == 'Enable Quick Link 1' || $field['field_name'] == 'Enable Quick Link 2' || $field['field_name'] == 'Enable Quick Link 3' || $field['field_name'] == 'Enable Quick Link 4')
                                                                    <hr>
                                                                    ...
                                                                    <div class="card-wrapper p-3 lead-common-box">
                                                                        @if(!empty($field['image_path']))
                                                                            @foreach($field['image_path'] as $key => $file_pathh)
                                                                                <div class="card mb-3 border shadow-none product_Image" data-value="{{$file_pathh}}">
                                                                                    <div class="px-3 py-3">
                                                                                        <div class="row align-items-center">
                                                                                            <div class="col ml-n2">
                                                                                                <p class="card-text small text-muted">

                                                                                                    <img class="rounded" src="{{ asset(Storage::url('uploads/' . $file_pathh)) }}"
                                                                                                    width="70px" alt="Image placeholder" data-dz-thumbnail>
                                                                                                </p>
                                                                                            </div>
                                                                                            <div class="col-auto actions">
                                                                                                <a class="action-item" href=" {{ asset(Storage::url('uploads/' . $file_pathh)) }}" download="" data-toggle="tooltip" data-original-title="{{__('Download')}}">
                                                                                                    <i class="fas fa-download"></i>
                                                                                                </a>
                                                                                            </div>
                                                                                            <div class="col-auto actions">
                                                                                                <a name="deleteRecord" class="action-item deleteRecord" data-name="{{$file_pathh}}">
