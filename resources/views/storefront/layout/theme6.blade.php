    ...
    <header class="header" id="header-main">
        ...
        <nav class=" {{ $getStoreThemeSetting[1]['section_enable'] == 'off' ? 'nav-secondary navbar navbar-expand-lg navbar-main navbar-transparent' : 'navbar navbar-main navbar-expand-lg navbar-transparent' }} {{ $navDark }}"
            ...
            <div class="container px-lg-0">
                <!-- Logo -->
                {{-- <a class="" href="#">
                    <img alt="Image placeholder" src="{{ asset('/assets/theme6/img/storego-image.png') }}"
                        class="white-logo">
                    <img alt="Image placeholder" src="{{ asset('/assets/theme6/img/logo-brown.png') }}"
                        ...
                        <li class="nav-item align-items-center d-flex nav-item">
                            ...
                            @if (Utility::CustomerAuthCheck($store->slug) == true)
                                <a href="{{ route('store.wishlist', $store->slug) }}"
                                    ...
                                    {{ $counterDark }}
                                    ">{{ !empty($wishlist) ? count($wishlist) : '0' }}</span>
                                </a>
                            @endif
                ...
                {{-- @foreach ($getStoreThemeSetting as $storethemesetting)
                    @if (isset($storethemesetting['section_name']) && $storethemesetting['section_name'] == 'Home-Email-Subscriber' && $storethemesetting['section_enable'] == 'on')
                        ...
                        <div class="col-lg-4 col-md-5 mb-4">
                            <h4 class="font-weight-300 text-secondary mb-3">
                            ...
                            {{ Form::open(['route' => ['subscriptions.store_email', $store->id], 'method' => 'POST']) }}
                                <div class="d-flex form-group">
                                    ...
                                    <button type="submit" class="border-0 btn btn-primary px-3 rounded-0">
                            ...
                            <p class="font-size-12">{{ __('Enter your address and accept the activation link') }}</p>
                    ...
                    @if ($getStoreThemeSetting[9]['section_enable'] == 'on')
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <a href="{{ route('store.slug', $store->slug) }}">
                                <img src="{{ asset(Storage::url('uploads/' . $getStoreThemeSetting[9]['inner-list'][0]['field_default_text'])) }}"
                                ...
                                @if (!empty($getStoreThemeSetting[10]))
                                    @if ((isset($getStoreThemeSetting[10]['section_enable']) &&
                                        ...
                                        <div class="col-6 col-lg-2 col-md-2 col-sm-4 mb-4 ml-lg-auto">
                                            <h6 class="font-size-12 heading ls-2 mb-3 text-secondary text-uppercase">
