                                                        ...
                                                        <div class="card bg-transparent">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div>
                                                                        <img alt=""
                                                                            src="{{ asset(Storage::url('uploads/' . (!empty($storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text']) ? $storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text'] : 'avatar.png'))) }}"
                    ...
                    @if (isset($storethemesetting['section_name']) &&
                        ...
                        @foreach ($storethemesetting['inner-list'] as $image)
                            ...
                            @else
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 ">
                                    <a href="#">
                                        <img src="{{ asset(Storage::url('uploads/theme1/header/logo4.png')) }}"
                                            alt="Footer logo">
                                    </a>
                                </div>
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 ">
