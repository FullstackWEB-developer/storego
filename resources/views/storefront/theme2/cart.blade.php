                    ...
                    <div class="container mt-7">
                        ...
                        <div class="row">
                            <div class="pr-title mb-4">
                                <h3 class=" mt-4 store-title t-secondary">{{ __('My Cart') }}</h3>
                                <div class="payment-step">
                                    <a href="{{ route('store.cart', $store->slug) }}" class="btn btn-mycart active">1 -
                                        {{ __('My Cart') }}</a>
                                        ...
                                        @foreach ($products['products'] as $key => $product)
                                            @if ($product['variant_id'] != 0)
                                                <tr class="alert" data-id="{{ $key }}">
                                                    ...
                                                    <td>
                                                        <div class="font-weight-bold t-gray p-title">{{ __('Tax') }}
                                                        </div>
                                                        @php
                                                            $total_tax = 0;
                                                        @endphp
                                            ...
                                            @else
                                                <tr class="alert" data-id="{{ $key }}">
                                                    ...
                                                    <td scope="row">
                                                        <div class="media align-items-center">
                                                            <a href="{{ route('store.product.product_view', [$store->slug, $product['id']]) }}"
                                                                class="text-dark c-list-title mb-0 cart_word_break">
                                ...
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-md-6 order-md-2 mb-4 mb-md-0">
                                        <div class="d-flex align-items-center justify-content-md-end">
                                            <span
                                                class="h6 text-white d-inline-block mr-3 mb-0">{{ __('Total value') }}:</span>
                                    ...
                                    <div class="col-md-6 order-md-1">
                                        ...
                                        <a href="{{ route('store.slug', $store->slug) }}"
                                            class="btn return-shop text-white">{{ __('Return to shop') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-md rounded-pill ">
        <div class="modal-content ">
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                    <a href="{{ route('user-address.useraddress', $store->slug) }}"
                        class="btn btn-yellow ms-2 rounded-pill">{{ __('Countinue as guest') }}</a>
                </div>
            </div>
        </div>
    </div>
