        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            <div class="carousel-inner" role="listbox">
                <div class="bg-cover bg-size--cover home-banner carousel-item active" data-offset-top="#header-main"
                    style="background-image: url({{ asset(Storage::url('uploads/' . (!empty($homepage_header_Bckground_Image) ? $homepage_header_Bckground_Image : 'home-banner1.png'))) }}); background-position: center center; padding-top: 77px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 cat-main-boxes">
                            <div class="categories-content">
                                <h2 class=" mt-4 store-title t-secondary">{{ !empty($Title) ? $Title : 'Categories' }}</h2>
                                ...
                                <div class="card-image">
                                    <a
                                        ...
                                        @if (!empty($topRatedProduct->product->is_cover) &&
                                            ...
                                            <img alt="Image placeholder"
                                                src="{{ asset(Storage::url('uploads/is_cover_image/' . (!empty($topRatedProduct->product->is_cover) ? $topRatedProduct->product->is_cover : ''))) }}"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="right-img"
                                style="background: url({{ asset(Storage::url('uploads/store_logo/' . (!empty($storethemesetting['subscriber_img']) ? $storethemesetting['subscriber_img'] : 'email_subscriber_2.png'))) }});">
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div class="card bg-transparent">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center collection-qoute">
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset(Storage::url('uploads/' . (!empty($storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text']) ? $storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text'] : ''))) }}"
                    ...
                    @if (isset($storethemesetting['section_name']) &&
                        ...
                        @foreach ($storethemesetting['inner-list'] as $image)
                            @if (!empty($image['image_path']))
                                @foreach ($image['image_path'] as $img)
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                        <a href="#">
                                            <img src="{{ asset(Storage::url('uploads/') . (!empty($img) ? $img : 'storego-image.png')) }}"
                                                alt="Footer logo">
                                        </a>
                                    </div>
                                @endforeach
                            @else
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 ">
                                    <a href="#">
                                        <img src="{{ asset(Storage::url('uploads/theme2/header/storego-image.png')) }}"
                                            alt="Footer logo">
