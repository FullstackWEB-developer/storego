    ...
    <div class="home-banner-slider">
        ...
        @foreach($getStoreThemeSetting as $storethemesetting)
            @if($storethemesetting['section_name'] == 'Banner-Image')
                <div class="banner-img th3" width="660" height="766" style="background: url({{asset(Storage::url('uploads/'.(!empty($storethemesetting['inner-list'][0]['field_default_text'])?$storethemesetting['inner-list'][0]['field_default_text']:'theme3/header/header_img_3.png')))}});">
                </div>
            @endif
        @endforeach
                @endif
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-lg-7 col-md-12 col-sm-12">
                                                                    ...
                                                                    src="{{ asset(Storage::url('uploads/' . (!empty($storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text']) ? $storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text'] : 'theme3/header/header_img_3.png'))) }}" class="tes-img">
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endfor
                                            ...
                                            {{-- @DD($storethemesetting['loop_number']) --}}
                                                ...
                                                <div class="swiper-slide" {{$i}}>
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-lg-7 col-md-12 col-sm-12">
                                                            <img alt="Image placeholder" height="530px" width="700px" src="{{asset(Storage::url('uploads/'.(!empty($storethemesetting['inner-list'][1]['field_default_text']) ? $storethemesetting['inner-list'][1]['field_default_text'] : 'theme3/header/header_img_3.png')))}}" class="tes-img">
                                                    </div>
                                                    </div>
                                                </div>
                                                @endfor
