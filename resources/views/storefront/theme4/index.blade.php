    ...
    @foreach ($getStoreThemeSetting as $ThemeSetting)
        @if (isset($ThemeSetting['section_name']) &&
            ...
            <section class="slice slice-xl bg-cover bg-size--cover home-banner " data-offset-top="#header-main"
                style="background-image: url({{ asset(Storage::url('uploads/' . $homepage_header_Bckground_Image)) }});
                                ...
                                @foreach ($storethemesetting['inner-list'] as $image)
                                            ...
                                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                                <a href="#">
                                                    <img class="logo-imare"
                                                        src="{{ asset(Storage::url('uploads/') . (!empty($img) ? $img : 'storego-image.png')) }}"
                                                        alt="logo">
                                                </a>
                                            </div>
                                        @endforeach
                                    @else
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 ">
                                            <a href="#">
                                                <img class="logo-imare"
                                                    src="{{ asset(Storage::url('uploads/theme4/header/brand_logo.png')) }}"
                                                    alt="Footer logo">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 ">
                        ...
                        @if ($storethemesetting['section_enable'] == 'on')
                            <div class="col-lg-8 col-md-7">
                                <img class="image-right out sidw"
                                    src="{{ asset(Storage::url('uploads/') . (!empty($storethemesetting['inner-list'][0]['field_default_text']) ? $storethemesetting['inner-list'][0]['field_default_text'] : 'banner_image.png')) }}"
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 categories-box">
                            <div class="cat-box">
                                ...
                                @if (!empty($topRatedProduct->product->is_cover) &&
                                    ...
                                    <img src="{{ asset(Storage::url('uploads/is_cover_image/' . (!empty($topRatedProduct->product->is_cover) ? $topRatedProduct->product->is_cover : ''))) }}"
    ...
    @foreach ($getStoreThemeSetting as $storethemesetting)
        @if (isset($storethemesetting['section_name']) &&
            ...
            <section class="slice slice-xl bg-cover bg-size--cover"
                style="background-image: url({{ asset(Storage::url('uploads/' . (!empty($emailsubs_img) ? $emailsubs_img : 'img-17.jpg'))) }}); background-position: center center;">
                <div class="container py-6">
                                                        ...
                                                        <div class="card bg-transparent">
                                                            <div class="card-body">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <img alt=""
                                                                            src="{{ asset(Storage::url('uploads/' . (!empty($storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text']) ? $storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text'] : 'qo.png'))) }}"
