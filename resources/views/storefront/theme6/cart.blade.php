            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-3 col-lg-2">
                        <h3 class="font-weight-400 m-md-0 text-secondary">My Cart</h3>
                    </div>
                    <div class="col-md-9 col-lg-10">
                        <div class="nav nav-tabs nav-fill border-0" id="nav-tab" role="tablist">
                            <div class="payment-step border border-secondary row no-gutters w-100">
                                <div class="col-sm-4">
                                        <a href="{{ route('store.cart', $store->slug) }}"  class="active-a tab-a border-0 btn btn-block text-secondary m-0 rounded-0">1 -
                                            {{ __('My Cart') }}</a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="{{ route('user-address.useraddress', $store->slug) }}" class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0">2 -
                                            {{ __('Customer') }}</a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="{{ route('store-payment.payment', $store->slug) }}" class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0">3 -
                                            {{ __('Payment') }}</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @if (!empty($products))
                                        ...
                                        @foreach ($products['products'] as $key => $product)
                                            @if ($product['variant_id'] != 0)
                                                <tr class="alert border-secondary" data-id="{{ $key }}">
                                                    <td class="px-0 border-0">
                                                        <span
                                                            class="badge-circle badge-lg bg-white border border-secondary ml-n3 text-secondary">{{ $counter++ }}</span>
                                                    </td>
                                                    <td class="border-0">
                                                    ...
                                                    <td scope="row" class="border-0">
                                                        <div class="media align-items-center">
                                                            <a href="{{ route('store.product.product_view', [$store->slug, $product['id']]) }}"
                                                                class="font-weight-400 h6 mb-0 text-secondary">
                                                                <h4 class="font-weight-500 mb-0 text-secondary">
                                                    ...
                                                    <td class="price border-0">
                                                        <div class="media-body pl-3">
                                                            ...
                                                            <div class="lh-100">
                                                                <span class="font-weight-400 mb-0 p-price text-secondary">
                                                                    {{ \App\Models\Utility::priceFormat($product['variant_price']) }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="qty-box border-0">
                                                        <span
                                                            class="font-weight-bold t-gray p-title">{{ __('Quantity') }}</span>
                                                        <div class="lh-100">
                                                            <span
                                                                class="font-weight-400 mb-0 p-price text-secondary">{{ $product['quantity'] }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="border-0">
                                                        <span
                                                    ...
                                                    <td class="border-0">
                                                        ...
                                                        @php
                                                            ...
                                                            $total += $totalprice;
                                                        @endphp
                                                        <p class="font-weight-500 pt-price text-secondary">
                                            ...
                                            @else
                                                <tr class="alert border-secondary" data-id="{{ $key }}">
                                                    <td class="px-0 border-0">
                                                        <span
                                                            class="badge-circle badge-lg bg-white border border-secondary ml-n3 text-secondary">
                                                            {{ $counter++ }}
                                                        </span>
                                                    </td>
                                                    <td class="border-0">
                                                    ...
                                                    <td scope="row" class="border-0">
                                                        <div class="media align-items-center">
                                                            <a class="font-weight-400 h6 mb-0 text-secondary"
                            ...
                            <div class="col-md-8 col-lg-6 mb-4 mb-md-0 ml-auto">
                                <div
                                    ...
                                    <div class="d-flex align-items-end mb-3 mb-sm-0">
                                        <span class="lh-100 mr-2 text-white">Total</span>
                                        <span class="cart-total font-weight-600 text-secondary">
                                ...
                                @endif --}}
                                    ...
                                    @if ($store_settings['is_checkout_login_required'] == null ||
                                        ...
                                        <a href="#"
                                            class="btn
                                        btn-secondary px-5 rounded-0"
                                            data-toggle="modal"
                                            data-target="#checkoutModal">{{ __('Proceed to checkout') }}</a>
                                    @else
                                        <a href="{{ route('user-address.useraddress', $store->slug) }}"
                                            class="btn
                                        btn-secondary px-5 rounded-0">{{ __('Proceed to checkout') }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>

                        <hr class="border-secondary mt-md-6 mb-5">
                        ...
                        <div class="row mt-5">
                            <div class="col-xl-8 col-lg-7">
                                <form>
                                    ...
                                    <div class="actions-toolbar py-2 mb-4">
                                        <h4 class="font-weight-400 mb-1 text-secondary">Billing information</h4>
                                    ...
                                    <div class="mb-4 mt-4 py-2">
                                        <div class="left-cart">
                                            <h4 class="font-weight-400 mb-1 text-secondary">Shipping informations</h4>
                                    ...
                                    <div class="mt-2 mt-sm-4 text-center text-sm-right">
                                        <a href="shop-landing.html" class="text-secondary">
                                            Return to shop
                                        </a>
                                        <a href="#" class="btn btn-secondary ml-sm-4 px-5 rounded-0">
                                            PROCEED TO
                                            CHECKOUT
                                        </a>
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-5 mt-5 mt-lg-0 col-md-7 mx-md-auto">
                                <div data-toggle="sticky" data-sticky-offset="30">
                                    <div class="card shadow-none border-secondary rounded-0" id="card-summary">

                                        <div class="bg-secondary card-header py-3 rounded-0">
                                            <div class="row align-items-center">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="border-bottom border-secondary m-0 py-3 row">
                                                <div class="col-7">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body ml-2">
                                                            <div class="sum-title lh-100">
                                                                <h6 class="mb-0 font-weight-300 text-secondary">APPLE TEA
                                                                </h6>
                                                                <p
                                                                    class="font-size-12 font-weight-300 mb-0 text-secondary">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <h5 class="font-weight-500 mb-0 text-secondary">$12.90</h5>
                                                    </div>
                                                    <span>
                                                        <a href="#">
                                            ...
                                            <div class="border-0 m-0 py-3 row">
                                                ...
                                                <div class="col-12">
                                                    <a href="#"
                                                        class="btn btn-block btn-secondary mt-4 rounded-0">PROCEED TO
                                                        CHECKOUT</a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane" data-id="tab3">
                        <div class="row mt-5">
                            <div class="col-xl-8 col-lg-7">
                                <form>
                                    <div class="card">
                                        <div class="border border-secondary border-sm box-space rounded-0 shadow-none">
                                            <div class="row align-items-center">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label t-gray font-600">Name on
                                                            card</label>
                                                        <input class="form-control border-secondary text-secondary"
                                    ...
                                    <div class="mt-2 mt-sm-4 text-center text-sm-right">
                                        <a href="shop-landing.html" class="text-secondary">Return to shop</a>
                                        <a href="#" class="btn btn-secondary ml-4 px-5 rounded-0">PROCEED TO
                                            CHECKOUT</a>
                                    </div>
                                </form>
                            </div>
    ...
    <div class="modal-dialog modal-md rounded-pill ">
        <div class="modal-content ">
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                    <a href="{{ route('user-address.useraddress', $store->slug) }}"
                        class="btn btn-secondary ms-2 rounded-pill">{{ __('Countinue as guest') }}</a>
                </div>
            </div>
        </div>
    </div>
