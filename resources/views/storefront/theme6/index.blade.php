    ...
    <div class="swiper-js-container position-relative home-banner">
        <div class="swiper-container" data-swiper-items="1" data-swiper-space-between="0">
            <div class="swiper-wrapper">
                ...
                @for ($i = 0; $i < $homepage_header_2['loop_number']; $i++)
                    ...
                    @if($getStoreThemeSetting[1]['section_enable'] == 'on')
                        <section class="slice slice-xl bg-cover bg-size--cover w-100 swiper-slide"
                            ...
                            style="background-image: url({{ asset(Storage::url('uploads/' . $homepage_header_bg_img)) }}); background-position: center center;">
                            <div class="container pb-md-6 pt-6 pt-md-8">
                                <div class="row  swiper-slide">
                                    <div class="col-lg-9 offset-1 offset-md-0">
                                        ...
                                        <div>
                                            <a href="#" class="btn mr-4 btn-outline-white mt-4 rounded-0" id="start_shopping">
                ...
                {{-- <section class="slice slice-xl bg-cover bg-size--cover w-100 swiper-slide"
                    data-offset-top="#header-main"
                    style="background-image: url({{asset('assets/theme6/img/home-banner1.jpg')}}); background-position: center center;">
                    <div class="container pb-md-6 pt-6 pt-md-8">
                        <div class="row  swiper-slide">
                            <div class="col-lg-9 offset-1 offset-md-0">
                                <h6 class="font-size-12 ls-3 t-white text-uppercase">BESTSELLER</h6>
                                <h2 class="font-merriweather h1 position-relative pr-md-6 store-title text-white">
                                    Discover the beauty contained in tea
                                    <span class="float-right position-absolute right-0 top-0 d-none d-md-block">
                                        <svg width="53" height="23" viewBox="0 0 53 23" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M51.839 10.44C51.3747 10.0086 40.3519 0 26.4939 0C12.6359 0 1.62533 10.0086 1.16095 10.44L0 11.5L1.16095 12.56C1.62533 12.9914 12.6359 23 26.4939 23C40.3519 23 51.3747 12.9914 51.839 12.56L53 11.5L51.839 10.44ZM47.3541 12.4614C42.8049 15.8541 37.6078 18.259 32.0908 19.5241L39.0932 12.4614H47.3541ZM39.3742 10.5386L32.4575 3.56214C37.8338 4.8647 42.8983 7.23651 47.3541 10.5386H39.3742ZM29.2435 3.04448L36.6735 10.5386H26.8972L20.0904 3.67311C22.1922 3.16456 24.3447 2.89988 26.5061 2.88424C27.4837 2.88424 28.388 2.9582 29.2924 3.04448H29.2435ZM24.1842 12.4614L17.9518 18.7476C13.5434 17.3282 9.38888 15.2059 5.64587 12.4614H24.1842ZM5.63363 10.5386C9.37746 7.78508 13.5369 5.65832 17.9518 4.24009L24.1842 10.5386H5.63363ZM20.0782 19.3269L26.8849 12.4614H36.3558L28.8891 19.9925C28.107 20.0541 27.3127 20.1158 26.445 20.1158C24.3164 20.0927 22.197 19.828 20.127 19.3269H20.0782Z"
                                                fill="white" />
                                        </svg>
                                    </span>
                                </h2>
                                <p class="lead text-white mt-4 store-dcs col-md-8 px-0">There is only that moment and
                                    the incredible certainty that everything under the sun has been written by one hand
                                    only.</p>
                                <div>
                                    <a href="#" class="btn mr-4 btn-outline-white mt-4 rounded-0">Start
                                        shopping</a>
                                    <a href="#" class="btn btn-primary mt-4 rounded-0">SPRAWDŹ NASZE HERBATY</a>
                                </div>
                            </div>
                                            ...
                                            <a
                                                ...
                                                @if (!empty($topRatedProduct->product->is_cover) &&
                                                    ...
                                                    <img alt="Image placeholder"
                                                        src="{{ asset(Storage::url('uploads/is_cover_image/' . $topRatedProduct->product->is_cover)) }}"
    ...
    @foreach ($getStoreThemeSetting as $storethemesetting)
        @if (isset($storethemesetting['section_name']) &&
            ...
            <section class="bg-cover bg-size--cove pb-10 pt-4"
                style="background-image: url({{ asset('assets/theme6/img/pexels-cottonbro.png') }}); background-position: center center; background-size: cover;">
...
{{-- <section class="bg-cover bg-size--cove pb-10 pt-4"
        ...
        <div class="container pb-250">
            <div class="row justify-content-center">
                <div class="col-sm-12 col-lg-12 col-xl-12 text-center">
                    <div class="mb-5">
                        <h2 class="font-weight-300 text-secondary"><span class="font-weight-500">There is only that
                                moment and the incredible certainty that</span> everything under the sun has been
                            written by one hand only.</h2>
                        <a href="#" class="btn btn-primary px-5 rounded-0">CHECK OUT OUR TEA</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach ($getStoreThemeSetting as $storethemesetting)
                    @php
                        ...
                        if ($storethemesetting['section_name'] == 'Home-Promotions' && $storethemesetting['array_type'] == 'inner-list') {
                            ...
                            echo '<img src="' . asset(Storage::url('uploads/' . $promotion_img)) . '" class="img-fluid">';
                        }
...
@endphp
                <section class="featured-product position-relative pt-5 pt-md-0 tabs-wrapper">
                    {{-- @DD( asset(Storage::url('uploads/' .  ) ) --}}
                    <img src="{{ asset(Storage::url('uploads/' . $test )) }}"
                        class="{{($getStoreThemeSetting[0]['section_enable'] == 'on' ? 'img-fluid d-none d-md-block' : 'banner-off')}}" id="shopping_section">
...
1
            ...
            <section class="categorie-section">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-5 text-center">
                                <h4 class="font-weight-300 my-3 text-secondary"> {{ !empty($Title) ? $Title : 'Categories' }}</h4>
                    ...
                    <div class="row justify-content-center">
                                ...
                                <div class="position-relative">
                                    <div class="cat-box">
                                        @if (!empty($pro_categorie->categorie_img) &&
                                            ...
                                            <img alt="Image placeholder"
                                                src="{{ asset(Storage::url('uploads/product_image/') . (!empty($pro_categorie->categorie_img) ? $pro_categorie->categorie_img : 'default.jpg')) }}">
                                        @else
                                            <img alt="Image placeholder"
                       ...
                       <div class="position-relative">
                           <div class="cat-box">
                               <img alt="Image placeholder" src="{{ asset('assets/theme6/img/blog02.jpg') }}">
                           </div>
                           <div class="cat-dcs text-left px-4 px-sm-2 px-md-4">
                               <h6 class="font-size-12 font-weight-300 ls-3 t-white text-uppercase mb-3">GUIDES</h6>
                               <h3 class="t-white text-left col-lg-8 px-0 mb-3">How to brew tea?</h3>
                               <a href="#" class="btn btn-outline-white py-2 rounded-0">READ MORE</a>
                           </div>
                       </div>
                   </div>
                   <div class="col-lg-4 col-sm-4 categories-box">
                       <div class="position-relative">
                           <div class="cat-box">
                               <img alt="Image placeholder" src="{{ asset('assets/theme6/img/blog03.jpg') }}">
                           </div>
                           <div class="cat-dcs text-left px-4 px-sm-2 px-md-4">
                               <h6 class="font-size-12 font-weight-300 ls-3 t-white text-uppercase mb-3">GUIDES</h6>
                               <h3 class="t-white text-left col-lg-8 px-0 mb-3">How to brew tea?</h3>
    ...
    {{-- <section class="image-with-text position-relative">
        <div class="container pb-4 pb-md-0">
            <div class="row align-items-center">
                <div class="col-md-6 ml-auto pl-md-4 pl-lg-6">
                    <img src="{{ asset('assets/theme6/img/logo-brown.png') }}" class="col-md-2 col-4 px-0 mb-4">
                    <h4 class="col-lg-10 font-weight-300 px-0 text-secondary mb-3 ls-1"><span
                            class="font-weight-500">There is only that moment and the incredible certainty that</span>
                        everything under the sun has been written by one hand only.</h4>
                    <p class="font-size-12 col-md-10 px-0 font-weight-300 text-secondary mb-lg-5">There is only that
                        moment and the incredible certainty that everything under the sun has been written by one hand
                        only.</p>
                    <a href="#" class="btn btn-primary rounded-0 px-5">CHECK OUT OUR TEA</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 px-0 mr-auto">
                                                ...
                                                <div class="swiper-slide p-3">
                                                    <div
                                                        ...
                                                        <div class="card-body pb-0">
                                                            ...
                                                            <div>
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset(Storage::url('uploads/' . $storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text'])) }}"
                                                                    class="w-25">
                                                            </div>
                                                ...
                                                <div class="swiper-slide p-3">
                                                    <div
                                                        ...
                                                        <div class="card-body pb-0">
                                                            ...
                                                            <div>
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset(Storage::url('uploads/' . (!empty($storethemesetting['inner-list'][1]['field_default_text']) ? $storethemesetting['inner-list'][1]['field_default_text'] : 'avatar.png'))) }}"
                                                                    class="w-25">
                                                            </div>
                                ...
                                @foreach ($image['image_path'] as $img)
                                    <div class="col-4 col-lg-2 col-md-3 col-sm-4 insta-item">
                                        <a href="#" class=" d-block">
                                            <img src="{{ asset(Storage::url('uploads/') . (!empty($img) ? $img : 'theme5/brand_logo/brand_logo.png')) }}"
                                                alt="Footer logo" class="img-fluid position-absolute top-0 left-0 w-100 ">
                                        </a>
                                        {{-- <p class="font-size-12 text-secondary pb-0 pt-2">@teahouse There is only that moment and the
                                                incredible certainty that</p> --}}
                                    </div>
                                @endforeach
                            @else
                                <div class="col-4 col-lg-2 col-md-3 col-sm-4 insta-item">
                                    <a href="#" class="position-relative d-block">
                                        <img src="{{ asset('assets/theme6/img/blog01.jpg') }}" alt="Footer logo"
