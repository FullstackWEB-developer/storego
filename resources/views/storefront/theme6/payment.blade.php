                        ...
                        <div class="payment-step border border-secondary row no-gutters w-100">
                            <div class="col-sm-4">
                                <a href="{{ route('store.cart', $store->slug) }}"
                                    class=" tab-a border-0 btn btn-block text-secondary m-0 rounded-0">1 -
                                    {{ __('My Cart') }}</a>
                            </div>
                            <div class="col-sm-4">
                                <a href="{{ route('user-address.useraddress', $store->slug) }}"
                                    class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0">2 -
                                    {{ __('Customer') }}</a>
                            </div>
                            <div class="col-sm-4">
                                <a href="{{ route('store-payment.payment', $store->slug) }}"
                                    class="active-a border-0 tab-a btn btn-block m-0 text-secondary rounded-0">3 -
                                    {{ __('Payment') }}</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane tab-active" data-id="tab3">
                                ...
                                <div class="box-space">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 text-right pr-0">
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-secondary btn-sm pt-0" type="submit">
                                    ...
                                    <div class="col-12 col-lg-4 col-md-4 text-right">
                                        ...
                                        <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="text-sm-right ">
                                                    <button type="submit"
                                                        class="btn btn-secondary btn-sm float-right">{{ __('Pay Now') }}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    @endif
                                ...
                                <div class="mt-2 mt-sm-4 text-center text-sm-right">
                                    <a href="{{ route('store.slug', $store->slug) }}" class="text-secondary">Return to shop</a>
                                ...
                                <div class="card shadow-none border-secondary rounded-0" id="card-summary">
                                    ...
                                    <div class="card-body p-0">
                                                ...
                                                @if (isset($product['variant_id']) && !empty($product['variant_id']))
                                                    <div class="border-bottom border-secondary m-0 py-3 row">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <small class="text-secondary">{{ __('Price') }}</small>
                                                                <h5 class="font-weight-500 mb-0 text-secondary">
                                                                    @php
                                        ...
                                        {{-- <div class="border-0 m-0 py-3 row">
                                            ...
                                            <div class="col-12">
                                                <a href="#" class="btn btn-block btn-secondary mt-4 rounded-0">PROCEED
                                                    TO CHECKOUT</a>
                                            </div>
                                        </div> --}}
